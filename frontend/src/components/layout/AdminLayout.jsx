                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3 min-w-0">
                            ...
                            >
                                ...
                                <div className={`w-10 h-10 bg-white rounded-xl flex items-center justify-center transition-opacity duration-200 border border-gray-100 ${isCollapsed ? 'group-hover:opacity-0' : ''}`}>
                                    <img src="/Zero-Waste Store.png" alt="Logo" className="w-8 h-8 object-contain" />
                                </div>
